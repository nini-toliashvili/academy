...
import com.example.homework_3.databinding.ExammLBinding

class Examm: AppCompatActivity()  {
    private lateinit var bindiing : ExammLBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        bindiing = ExammLBinding.inflate(layoutInflater)
